...
from lib.conf import (
    default_output_format, default_output_channel,
...
from lib.UI import CUSTOM_CSS

# ─── Page Config ───────────────────────────────────────────────────────────

st.set_page_config(
    page_title="VoxLibrik",
    page_icon="📚",
    layout="wide",
...
├── build.py            # Main Installer & Launcher
├── requirements.txt
├── lib/
│   ├── conf.py
│   ├── conf_lang.py    # English + Tamil
│   ├── conf_models.py
│   ├── core.py         # Conversion engine
│   ├── streamlit_ui.py # Streamlit GUI (this file)
│   └── classes/
├── voices/
│   ├── eng/
│   └── tam/
...
""", language="")
        ...
        st.code("./build.py", language="bash")
